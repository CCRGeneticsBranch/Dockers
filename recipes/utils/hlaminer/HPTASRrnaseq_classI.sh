...
/opt2/HLAminer-1.4/HLAminer_v1.4/bin/parseXMLblast.pl -c ncbiBlastConfigO.txt -d /opt2/HLAminer-1.4/HLAminer_v1.4/database/HLA_ABC_CDS.fasta -i TASRhla200.contigs -o 0 -a 1 > tig_vs_hla-ncbi.coord
###Align HLA references to contigs
echo "Aligning HLA references to TASR contigs (go have a coffee, it may take a while)..."
/opt2/HLAminer-1.4/HLAminer_v1.4/bin/parseXMLblast.pl -c ncbiBlastConfigO.txt -i /opt2/HLAminer-1.4/HLAminer_v1.4/database/HLA_ABC_CDS.fasta -d TASRhla200.contigs -o 0 > hla_vs_tig-ncbi.coord
###Predict HLA alleles
